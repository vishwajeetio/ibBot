...
class LivePurpose:
    ...
    def tableWithScalp(self):
        ...
        addRadioH = Entry(tableFrame, font = 'Times 16 bold', fg = '#5236e0', width = 5)
        addRadioH.insert(END, '  Add')
        addRadioH.config(state = 'disabled')
        addRadioH.configure({"disabledbackground": '#f0f5ff', "disabledforeground": '#5236e0'})
        addRadioH.grid(row = 0, column = 3, ipady = 8)
        self.addRV = IntVar()
